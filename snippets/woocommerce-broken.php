...
add_action( 'plugins_loaded', function () {
    if ( class_exists( 'WooCommerce' ) ) {
        ...
        // functions.php del child theme o plugin custom
        add_action('woocommerce_single_product_summary', function () {
            // Stampiamo i link sotto al pulsante "Aggiungi al carrello"
        ...
        add_action('wp_enqueue_scripts', function () {
            ...
            // “finto” handle per attaccare lo style inline sopra (se il tema non registra woocommerce-inline)
